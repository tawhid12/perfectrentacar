    ...
    <div class="container full-width">
        ...
        <div class="main-slider">
            <div class="owl-carousel" id="main-slider">
                ...
                <!-- Slide 1 -->
                <div class="item" style="background-image:url('{{ the_image_url($post->img,'thumbnail-870x600') }}')"><!--ver1-->
                    <div class="caption">
                        <div class="container">
                            <div class="div-table">
                                <section class="contact">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 wow fadeInRight" data-wow-offset="200" data-wow-delay="200ms" style="font-size:16px">

                                                <p style="font-size:20px;">{{__(" At Perfect Line,Our customer's satisfaction comes first,We provide mobility solutions that benefit")}}</p>
