...
(function ($) {
    ...
    wpWidgets = {
        ...
        init: function () {
            ...
            $('.widget-control-save').on('click', function (e) {
                e.preventDefault();
            ...
            /*$(window).on('beforeunload.widgets', function (event) {
                ...
                if (0 !== dirtyWidgetIds.length) {
                 ...
                 //   console.log(unsavedWidgetsElements);
        ...
        saveOrder: function (sidebarId) {
            ...
            if (sidebarId) {
                ...
                $('.cssload-speeding-wheel.'+sidebarId).show();
            }
            ...
            $.ajax({
                ...
                success: function (res) {
                    $('#' + sidebarId).prepend(res);
                    $('#inactive-widgets-control-remove').prop('disabled', !$('#wp_inactive_widgets .widget').length);
                    $('.spinner').removeClass('is-active');

                    $('.cssload-speeding-wheel.'+sidebarId).hide();
                },
                error: function (msg) {
                    $('#inactive-widgets-control-remove').prop('disabled', !$('#wp_inactive_widgets .widget').length);
                    $('.spinner').removeClass('is-active');
        ...
        save: function (widget, del, animate, order) {
            ...
            if (!del && !isAdd && form.prop('checkValidity') && !form[0].checkValidity()) {
             ...
             widget.find('.cssload-speeding-wheel').show();
            data = form.serialize();
            ...
            $.ajax({
                ...
                success: function (r) {
                    ...
                    widget.find('.cssload-speeding-wheel').hide();
                    if (order) {
                        wpWidgets.saveOrder();
                    }
