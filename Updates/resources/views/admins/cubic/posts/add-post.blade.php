            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <form method="post"
                              action="{{  (isset($post->id)) ? route('admin.posts.update',['post'=>$post->id]) : route('admin.posts.store')  }}">
                                                ...
                                                <label class="control-label"> {{__('admin.Permalink:')}}
                                                    ...
                                                    @if(isset($post->id))
                                                        ...
                                                        <a class="" target="_blank"
                                                           href="{{ route('admin.posts.show',['post' => $post->id])}}">{{ route('admin.posts.show',['post' => $post->id])}}</a>
