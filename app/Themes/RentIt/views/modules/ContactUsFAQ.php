<section  id="<?php  echo $id; ?>"  class="edit page-section contact dark pb-module-section">
                ...
                <form name="contact-form" method="post" action="#" class="edit contact-form alt" id="contact-form">
                            ...
                            <div class="edit outer required">
                                <div class="edit form-group af-inner has-icon">
                                    ...
                                    <input
                                            ...
                                            class="edit form-control placeholder"/>
                    ...
                    <div class="edit form-group af-inner has-icon">
                        ...
                        <textarea
                                ...
                                class="edit form-control placeholder"></textarea>
