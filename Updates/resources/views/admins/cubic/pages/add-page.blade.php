            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <form method="post"
                              action="{{  (isset($page->id)) ? route('admin.pages.update',['page'=>$page->id]) : route('admin.pages.store')  }}">
                                                ...
                                                <label class="control-label"> {{__('admin.Permalink:')}}
                                                    ...
                                                    @if(isset($page->id))
                                                        ...
                                                        <a class="" target="_blank"
                                                           href="{{ route('admin.pages.show',['page' => $page->id])}}">{{ route('admin.pages.show',['page' => $page->id])}}</a>
