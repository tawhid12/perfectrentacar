            ...
            <div class="">
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <form action="{{route('admin.translates.plugin.store',['slug' =>$path])}}" method="post">
                            @csrf
                            ...
                            @if(getOption('LANG') && $langs = getOption('custom_langs'))
                                ...
                                <div class="entry language">
                                    ...
                                    <label>
                                        {{__(' select the language in which you want to translate this plugin')}}
                                        <select onchange="  window.location = '{{route('admin.translates.plugin',['slug' =>$path])}}?lang='+ $(this).val();" name="language" class="form-control">
