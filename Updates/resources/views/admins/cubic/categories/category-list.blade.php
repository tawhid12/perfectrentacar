    ...
    <tr>
        ...
        <td>{!! str_repeat( '—', $Level )  !!} {{$item->title ?? ''}}
            ...
            <div class="pull-right">
                ...
                <a href="{{ isset($portfolio) ?  route( 'admin.por_categories.edit', [ 'por_category' => $item->id]  ) : route( 'admin.categories.edit', [ 'por_category' => $item->id]  )}}" class="text-inverse p-r-10"
