            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <form method="post"
                              action="{{  (isset($portfolio->id)) ? route('admin.portfolio.update',['portfolio'=>$portfolio->id]) : route('admin.portfolio.store')  }}">
                                                ...
                                                <label class="control-label"> {{__('admin.Permalink:')}}
                                                    ...
                                                    @if(isset($portfolio->id))
                                                        ...
                                                        <a class="" target="_blank"
                                                           href="{{ route('admin.portfolio.show',['portfolio' => $portfolio->id])}}">{{ route('admin.portfolio.show',['portfolio' => $portfolio->alias])}}</a>
