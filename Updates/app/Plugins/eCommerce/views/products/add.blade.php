            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form method="POST"
                              action="{{  (isset($product->id)) ? route('admin.products.update',['product'=>$product->id]) : route('admin.products.store')  }}">
                                            ...
                                            @if($product ?? false)
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <a target="_blank"
                                                           href="{{route('products.show',['alias'=> $product->alias ])}}">{{route('products.show',['alias'=> $product->alias ])}}</a>
                                                    </div>
                                                </div>
                                        @endif
                                        <!--/span-->
